...
/**
 * Response from OpenAI's API. This is similar to a {@link java.util.concurrent.CompletableFuture CompletableFuture}.
 * @see Request
 *
 * @author Seailz
 * @since 1.0.0
...
public class Response<T> {
    ...
    /**
     * Represents an error received from OpenAI's API.
     */
